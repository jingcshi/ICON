...
from typing import Hashable, Iterable, List, Literal, Optional, Set, Type, Union
...
class Taxonomy(nx.DiGraph):
    ...
    def get_parents(self, n: Hashable, labels: Optional[Iterable[str]]=None, return_type: Union[Type[List[Hashable]], Type[Set[Hashable]]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
    ...
    def get_children(self, n: Hashable, labels: Optional[Iterable[str]]=None, return_type: Union[Type[List[Hashable]], Type[Set[Hashable]]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
    ...
    def get_ancestors(self, node: Hashable, labels: Optional[Iterable[str]]=None, return_type: Union[Type[List[Hashable]], Type[Set[Hashable]]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
    ...
    def get_descendants(self, node: Hashable, labels: Optional[Iterable[str]]=None, return_type: Union[Type[List[Hashable]], Type[Set[Hashable]]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
    ...
    def get_ancestors_by_depth(self, node: Hashable, max_depth: int=1, labels: Optional[Iterable[str]]=None, return_type: Union[Type[List[Hashable]], Type[Set[Hashable]]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
    ...
    def get_descendants_by_depth(self, node: Hashable, max_depth: int=1, labels: Optional[Iterable[str]]=None, return_type: Union[Type[List[Hashable]], Type[Set[Hashable]]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
    ...
    def subsumes(self, u: Hashable, v: Hashable, labels: Optional[Iterable[str]]=None) -> bool:
        '''
    ...
    def reduce_subset(self, subset: Iterable[Hashable], labels: Optional[Iterable[str]]=None, reverse: bool=False, return_type: Union[Type[list], Type[set]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
        ...
        if reverse:
            def func(n):
                return self.get_ancestors(n, labels=labels, return_type=set)
        else:
            def func(n):
                return self.get_descendants(n, labels=labels, return_type=set)
        subset = set(subset)
    ...
    def get_LCA(self, nodes: Iterable[Hashable], labels: Optional[Iterable[str]]=None, return_type: Union[Type[list], Type[set]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
    ...
    def get_GCD(self, nodes: Iterable[Hashable], labels: Optional[Iterable[str]]=None, return_type: Union[Type[list], Type[set]]=list) -> Union[List[Hashable], Set[Hashable]]:
        '''
    ...
    def filter_by_level(self, top_level: int=0, bottom_level: int=0, cached_levels: bool = False, return_type: Literal[list, set]=list) -> Union[Type[list], Type[set]]:
        ...
        if top_level > 0:
            def top_level_check(n):
                return n['_level'] >= top_level
        elif top_level < 0:
            def top_level_check(n):
                return n['_reverse_level'] <= -top_level
        else:
            def top_level_check(n):
                return True

        if bottom_level > 0:
            def bottom_level_check(n):
                return n['_reverse_level'] >= bottom_level
        elif bottom_level < 0:
            def bottom_level_check(n):
                return n['_level'] <= -bottom_level
        else:
            def bottom_level_check(n):
                return True
    ...
    def create_move_search_space(self, target: Hashable, scope_top_level: int=0, scope_bottom_level: int=0) -> Taxonomy:
        ...
        if scope_top_level > 0:
            def verify_top(x):
                return self.nodes[x]['_level'] >= scope_top_level
        elif scope_top_level < 0:
            def verify_top(x):
                return self.nodes[x]['_reverse_level'] <= -scope_top_level
        else:
            def verify_top(x):
                return True

        if scope_bottom_level > 0:
            def verify_bottom(x):
                return self.nodes[x]['_reverse_level'] >= scope_bottom_level
        elif scope_bottom_level < 0:
            def verify_bottom(x):
                return self.nodes[x]['_level'] <= -scope_bottom_level
        else:
            def verify_bottom(x):
                return True
        ...
        while queue:
            ...
            valid = verify_top(node) and verify_bottom(node)
            if valid:
                subgraph.add_node(node,label=self.get_label(node))
                if prev_valid:
...
def from_json(file_path: Union[str, os.PathLike], as_tree: bool=False) -> Taxonomy:
    ...
    for n in obj['nodes']:
        ...
        nid = n.pop('id')
        if 'label' not in n:
            raise ValueError(f'Missing node label for node {nid}')
        taxo.add_node(nid,**n)
    for e in obj['edges']:
        if 'src' not in e:
    ...
    def add_edge(self, u_of_edge: Hashable, v_of_edge: Hashable, overwrite=False, **attr) -> Literal[0,1]:
        ...
        if existing_parents:
            if overwrite:
                ...
                existing_p = list(existing_parents.keys())
                raise nx.NetworkXError(f'Edge not added because it would cause multi-inheritance. If you want to overwrite the existing edge ({u}, {existing_p}), set overwrite=True')
